<?php
    ...
    $xprog_module_log = 'TRANSACTION DETAILS';
    $xactivity_log = 'export_pdf';
    $xremarks_log = "Exported PDF from Transaction Details";
    ...
    $fields = '';
        ...
        $select_db_file1="SELECT tranfile1.docnum as tranfile_docnum, customerfile.cusdsc as customerfile_cusdsc, 
        ...
        FROM tranfile1 LEFT JOIN customerfile ON tranfile1.cuscde = customerfile.cuscde WHERE tranfile1.recid=?";
        ...
        $pdf->ezPlaceData($xleft+=115,$xtop,"<b>Shop Name:</b>",10,'left');
        ...
        $pdf->ezPlaceData($xleft+=50,$xtop,trim_str($shipto, 105,10),10,'left');
        ...
        $pdf->ezPlaceData($xleft+=65,$xtop,trim_str($ordernum, 100,10),10,'left');
        $pdf->ezPlaceData($xleft+=100,$xtop,"<b>Total:</b>",10,'left');
        $pdf->ezPlaceData($xleft+=100,$xtop,number_format($trntot,"2"),10,'right');
        ...
        $pdf->ezPlaceData($xleft+=90,$xtop,"<b>Quantity</b>",10,'left');
    ...
    while($rs_file2 = $stmt_main_file2->fetch()){    
        ...
        $pdf->ezPlaceData($xleft+=90,$xtop,number_format($rs_file2["tranfile2_itmqty"]),9,"left");
        $pdf->ezPlaceData($xleft+=125,$xtop,number_format($rs_file2["tranfile2_untprc"],2),9,"right");
        $pdf->ezPlaceData($xleft+=85,$xtop,number_format($rs_file2["tranfile2_extprc"],2),9,"right");
    ...
    $pdf->ezPlaceData(260,$xtop-18,"<b>Grand total:</b>",9 ,'right');
    $pdf->ezPlaceData(325,$xtop-18,"<b>".number_format($trntot,"2")."</b>",9 ,'right');
