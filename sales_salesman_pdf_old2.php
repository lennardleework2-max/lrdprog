...
*/
    ...
    $select_db="SELECT mf_routes.route_desc as mf_routes_route_desc, tranfile1.shipto as tranfile1_shipto,tranfile1.salesman_id as tranfile1_salesman_id,tranfile1.docnum as tranfile1_docnum,
    ...
    WHERE true AND tranfile1.trncde='".$_POST['trncde_hidden']."' ".$xfilter." ".$xfilter_smn." ORDER BY mf_salesman.salesman_name ASC,tranfile1.trndte ASC";
    ...
    while($rs_main = $stmt_main->fetch()){    
        ...
        $pdf->ezPlaceData($xleft+=70,$xtop,$rs_main["mf_routes_route_desc"],9,"left");
