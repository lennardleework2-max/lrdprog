...
?>         
    ...
    <form name='myforms' id="myforms"> 
                    ...
                    <td colspan=1 class="td_br">
                        <div class="container-fluid mt-2 main_br_div">
                            ...
                            <div class="container-fluid my-2">
                                <div class="row">
                                    <div class="col-1" style='padding-left:0;margin-left:0;'>
                                        <h2 class='my-2'>Sales</h2>
                                    </div>
                            ...
                            <table class="shadow" style='border-radius:.75rem!important;width:100%;margin-bottom:1rem' id='sales_main_table'>
                                <thead style='border-bottom:2px solid black;'>
                                    <tr>
                                    <th scope="col" style='width:80%;padding: 0.5rem 0.5rem;font-size:23px'>Sales</th>
                                    <?php
            ...
            <span id='hidden_search_input'>
                ...
                <input type="hidden" name="salesman_search_h" id="salesman_search_h" value="<?php if(isset($_POST['salesman_search_h'])){echo $_POST['salesman_search_h'];}?>">
    ...
    <div class="modal fade" id="searchModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content fw-bold">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Search Sales</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row m-3">
                        ...
                        <div class="col-4">
                            <label for="">Paid:(Salesman)</label>
                            <select name="paid_salesman_search" id="paid_salesman_search" class="form-control">
                                <option value="all">All</option>
                                <option value="paid">Paid</option>
                                <option value="not_paid">Not Paid</option>      
                            </select>
                        ...
                        <div class="col-4">
                            ...
                            <select name="salesman_search" id="salesman_search" class="form-control">
                                    <?php
                        ...
                        <div class="col-4">
                            <div>
                                ...
                                <select name="sortby_1_field" id="sortby_1_field" class="form-control mt-2">
                                    ...
                                    <option value="cuscde">Shop Name</option>
    ...
    <script>
        ...
        function ajaxFunc2(event ,recid, xextra){
            ...
            switch(event) {
                ...
                case "getEdit":
                    ...
                    document.forms.myforms.action = "trn_salesfile2.php";
            ...
            jQuery.ajax({    
                ...
                dataType:"json",
                type:"post",
                url:"trn_salesfile1_ajax_crud.php", 
        ...
        function print_file2(recid){
            ...
            document.forms.myforms.action = "sales_tranfile2_pdf.php";
            document.forms.myforms.submit();
        }
        ...
        function page_click_sales(event_action, xextra){
            ...
            if(event_action == "search"){
                ...
                var salesman_search = $("#salesman_search").val();
                $("#salesman_search_h").attr('value', salesman_search);
                //alert($("#salesman_search_h").val());
                ...
                $("#paid_search_h").val(paid_search);

                var paid_salesman_search = $("#paid_salesman_search").val();
                $("#paid_salesman_search_h").val(paid_salesman_search);
            ...
            jQuery.ajax({    
                ...
                dataType:"json",
                type:"post",
                url:"trn_salesfile1_ajax_pager.php", 
        ...
        function erase(){
            ...
            $("#paid_salesman_search").val($("#paid_salesman_search option:first").val());
