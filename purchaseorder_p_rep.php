...
?>
                                        ...
                                        <div class="w-100 h-100 d-flex justify-content-center align-items-top">
                                            <div class="m-2" style='width:80%'>
                                                ...
                                                <select class="form-select" id="cus_search" name="cus_search" autocomplete="off">
                                                    ...
                                                    <?php
                                                        $select_db_customerfile="SELECT * FROM supplierfile ORDER BY suppdsc";
                                                        ...
                                                        while($rs_customerfile = $stmt_customerfile->fetch()){
                                                            ...
                                                            echo "<option value='".$rs_customerfile['suppdsc']."'>".$rs_customerfile['suppdsc']."</option>";
                                                        }
                                                    ?>
                                                </select>
                                            </div>
                                    ...
                                    <td colspan="2">
                                        <div class="w-100 h-100 d-flex justify-content-center align-items-top">
                                            <div class="m-2" style="width:80%">
                                                ...
                                                <select name="purchase_type" id="purchase_type" class="form-select">
                                                    <option>all</option>
                                                    <option>trade</option>
                                                    <option>non-trade</option>
                                                </select>
    ...
    <script>
            function exp_pdf(){
                ...
                document.forms.myforms.action = "p_rep_purchaseorder.php";
