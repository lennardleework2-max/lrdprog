...
?>
                ...
                <td colspan=1 class="td_br" id="td_br">
                    <div class="container-fluid w-100 h-100 d-flex justify-content-center">
                        <div class="row h-100 w-100 justify-content-center align-items-center">
                            <table style='height:80%;background-color:white;width:40%' id='date_table'>
                                <tr>
                                    <td colspan="2" class="text-center">
                                    <h3>Sales Order </br>by Ordered Date (With Item)</h3>
                                    </td>
                                </tr>
    ...
    <script>
            function exp_pdf(){
                ...
                document.forms.myforms.action = "date_ordered_witem_rep_salesorder.php";
