<?php
    ...
    $fields = '';
        ...
        $pdf->ezPlaceData($xleft+=210,$xtop,"<b>Quantity</b>",10,'right');
    ...
    while($rs_main = $stmt_main->fetch()){    
        ...
        while($rs_main2 = $stmt_main2->fetch()){   
            ...
            // $pdf->ezPlaceData($xleft+60,$xtop,"ITEM:",9,"left");
            $pdf->ezPlaceData($xleft+=210,$xtop,$rs_main2["itmqty"],9,"right");
            $pdf->ezPlaceData(205,$xtop,$rs_main2["itmdsc"],9,"left");
        ...
        $xtop -= 15;
        $xleft = 0;
        $pdf->ezPlaceData($xleft+=420,$xtop+=5,"<b>TOTAL:</b>",9,"left");
    ...
    $xtop -= 15;
    $xleft = 0;
    $pdf->ezPlaceData($xleft+=393,$xtop+=5,"<b>GRAND TOTAL:</b>",8,"left");
