...
$trncde = "ADJ";
$prog_name = "Innentory Adjustments";
?>         
    <style>
                        ...
                        <div class="container-fluid mt-2 main_br_div">
                            ...
                            <div class="container-fluid my-2">
                                <div class="row">
                                    <div class="col-6" style='padding-left:0;margin-left:0;'>
                                        <h2 class='my-2'>Inventory Adjustments</h2>
                                    </div>
                            ...
                            <table class="shadow" style='border-radius:.75rem!important;width:100%;margin-bottom:1rem' id='sales_main_table'>
                                <thead style='border-bottom:2px solid black;'>
                                    <tr>
                                    <th scope="col" style='width:80%;padding: 0.5rem 0.5rem;font-size:23px'>Inventory Adjustments</th>
                                    <?php
    ...
    <div class="modal fade" id="searchModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content fw-bold">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Search Inventory Adjustments</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                        ...
                        <div class="col-4">
                            <div>
                                ...
                                <select name="sortby_1_field" id="sortby_1_field" class="form-control mt-2">
                                    ...
                                    <!-- <option value="cuscde">Customer Name</option> -->
