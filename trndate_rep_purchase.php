<?php
    ...
    if(isset($_POST['paid_chk']) && $_POST['paid_chk'] == "on"){
        $xfilter .= " AND paydate IS NOT NULL AND paydate !='' ";
    }

    $xfilter_order = "";
    if(isset($_POST['orderby_ordernum'])  && !empty($_POST['orderby_ordernum'])){
        $xfilter_order = " ORDER BY ordernum ".$_POST['orderby_ordernum'].", trndte ".$_POST['orderby_ordernum']."";
    }else{
        $xfilter_order =  " ORDER BY trndte ASC";
    }
    ...
    tranfile1.suppcde = supplierfile.suppcde WHERE true AND trncde='".$_POST['trncde_hidden']."' ".$xfilter."  ".$xfilter_order."";
    ...
    while($rs_main = $stmt_main->fetch()){    
        ...
        $pdf->ezPlaceData($xleft+=60,$xtop,$rs_main["tranfile1_ordernum"],9,"left");
        ...
        $pdf->ezPlaceData($xleft+194,$xtop,number_format($rs_main["tranfile1_trntot"],"2"),9,"right");
