<?php
    ...
    while($rs_main = $stmt_main->fetch()){    
        ...
        $select_db2 = "SELECT * FROM tranfile2 LEFT JOIN tranfile1 ON tranfile2.docnum= tranfile1.docnum WHERE itmcde='".$rs_main['itmcde']."' ".$xfilter2." ORDER BY tranfile1.trndte ASC";
        ...
        while($rs_main2 = $stmt_main2->fetch()){   
            ...
            $pdf->ezPlaceData($xleft+=80,$xtop, trim_str($rs_main3['ordernum'],90,9),9,"left");
            $pdf->ezPlaceData($xleft+=95,$xtop,trim_str($rs_main3["cusdsc"],140,9),9,"left");
            ...
            $pdf->ezPlaceData($xleft+=45,$xtop,number_format($rs_main2["itmqty"]),9,"left");
            $pdf->ezPlaceData($xleft+=125,$xtop,number_format($rs_main2["extprc"],2),9,"right");
            $xtop -= 15;
        ...
        $pdf->ezPlaceData(475,$xtop-9,"<b>Subtotal:</b>",9 ,'left');
        $pdf->ezPlaceData(595,$xtop-9,"<b>".number_format($subtotal,2)."</b>",9 ,'right');
    ...
    $pdf->ezPlaceData(475,$xtop-18,"<b>Grand total:</b>",9 ,'left');
    $pdf->ezPlaceData(595,$xtop-18,"<b>".number_format($grand_total,2)."</b>",9 ,'right');
