...
//LOOP THROUGH TRANFILE1 fill salesman_id from mf_buyers - buyer_id
...
while($rs = $stmt->fetch()){
    if (isset($rs['buyer_id']) && $rs['buyer_id']!=null){
        ...
        if (isset($rs2['salesman_id']) && $rs2['salesman_id']!=null){
            $sql5 = "UPDATE tranfile1 SET salesman_id='".$rs2['salesman_id']."' WHERE recid='".$rs['recid']."'";
