                    ...
                    <td colspan=1 class="td_br">
                        <div class="container-fluid mt-2 main_br_div">
                            ...
                            <?php
                                if($view_crud == 1){
                            ?>
                            <table class="shadow shadow rounded"  style='border-radius:.75rem!important;width:100%;margin-bottom:1rem' id='data_table'>
                                <thead style='border-bottom:2px solid black;'>
                                    <tr>
                                    <th scope="col" style='width:80%;padding: 0.5rem 0.5rem;font-size:23px'>Sales Order</th>
                                    <?php
    ...
    <div class="modal fade" id="searchModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content fw-bold">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Search Sales Order</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
...
<!-- 
                        <div class="col-md-3 col-6">
                            <label for="">Ordered Date. From:</label>
                            <input type="text" name="from_search_ordered" id="from_search_ordered" class="form-control date_picker" autocomplete="off" readonly>
                        </div>
                        <div class="col-md-3 col-6">
                            <label for="">Ordered Date. To:</label>
                            <input type="text" name="to_search_ordered" id="to_search_ordered" class="form-control date_picker" autocomplete="off" readonly>
                        </div>                         -->

                        <div class="col-6 col-md-4">
                            <label for="">Order Num:</label>
                            <input type="text" name="ordernum_file_search" id="ordernum_file_search" class="form-control" autocomplete="off">
                        </div>
                    ...
                    <div class="row m-3">
                        ...
                        <!-- <div class="col-6 col-md-3">
                            ...
                            <input type="text" name="waybill_num_search" id="waybill_num_search" class="form-control" autocomplete="off">
                        </div> -->
                    </div>
                        ...
                        <div class="col-md-4 col-6">
                            <div>
                                ...
                                <select name="sortby_1_field" id="sortby_1_field" class="form-control mt-2">
                                    ...
                                    <option value="cuscde">Platform Name</option>
                                    <option value="orderby">Ordered By</option>
                                    <option value="file_created_date">Ordered Date</option>
                                    <option value="file_ordernum">Order Number</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-6">
                            <div>
                                ...
                                <select name="sortby_2_field" id="sortby_2_field" class="form-control mt-2">
                                    ...
                                    <option value="docnum">Doc. No.</option>
                                    <option value="trndte">Tran. Date</option>
                                    <option value="cuscde">Platform</option>
                                    <option value="orderby">Ordered By</option>
                                    <option value="file_created_date">Ordered Date</option>
                                    <option value="file_ordernum">Order Number</option>
                                </select>
    ...
    <script>
        ...
        function ajaxFunc2(event ,recid, xextra){
            ...
            switch(event) {
                ...
                case "getEdit":
                    ...
                    document.forms.myforms.action = "trn_salesorderfile2.php";
            ...
            jQuery.ajax({    
                ...
                dataType:"json",
                type:"post",
                url:"trn_salesorderfile1_ajax_crud.php", 
        ...
        function print_file2(recid){
            ...
            document.forms.myforms.action = "salesorder_tranfile2_pdf.php";
            document.forms.myforms.submit();
        }
        ...
        function page_click_sales(event_action, xextra){
            ...
            if(event_action == "search"){
                ...
                var from_search_ordered = $("#from_search_ordered").val();
                $("#from_ordered_search_h").val(from_search_ordered);
 
                var to_search_ordered = $("#to_search_ordered").val();
                $("#to_ordered_search_h").val(to_search_ordered);    
                
                var ordernum_file_search = $("#ordernum_file_search").val();
                $("#ordernum_file_search_h").val(ordernum_file_search);   

                var waybill_num_search = $("#waybill_num_search").val();
                $("#waybill_num_search_h").val(waybill_num_search);   
            ...
            jQuery.ajax({    
                ...
                dataType:"json",
                type:"post",
                url:"trn_salesorderfile1_ajax_pager.php", 
        ...
        function erase(){
            ...
            $("#from_search").val('');
            $("#to_search").val('');
            $("#from_search_ordered").val('');
            $("#to_search_ordered").val('');
            $("#ordernum_file_search").val('');
            $("#waybill_num_search").val('');
            $("#cusname_search").val('');
            $("#ordernum_search").val('');
