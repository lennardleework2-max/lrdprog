<?php
    ...
    $fields = '';
        ...
        $pdf->filledRectangle(80, $xtop+=30, 510, 30); // Adjust as needed
        ...
        $pdf->filledRectangle(120, $xtop-50, 470, 45); // Adjust as needed

        $xtop+=5;

        $pdf->setColor(0, 0, 0);
        $pdf->ezPlaceData($xleft+=6, $xtop-21, 'To:', 12, 'left' );
        $pdf->ezPlaceData($xleft+=95, $xtop-21, $rs_main_docnum['mf_buyers_buyername'], 12, 'left' );
        $xleft = 25;
        $pdf->ezPlaceData($xleft+=6, $xtop-37, 'Address:', 12, 'left' );
        $pdf->ezPlaceData($xleft+=95, $xtop-37, $rs_main_docnum['mf_buyers_buyeraddress'], 11, 'left' );
        $xleft = 25;
        $pdf->ezPlaceData($xleft+=6, $xtop-52, 'Contact No. :', 12, 'left' );
        $pdf->ezPlaceData($xleft+=95, $xtop-52, $rs_main_docnum['mf_buyers_buyer_contactnum'], 12, 'left' );
        ...
        $pdf->line($xleft, $xtop-=15,590, $xtop); // vertical line
        $pdf->line($xleft, $xtop-=15,590, $xtop); // vertical line
        $pdf->line($xleft, $xtop-=15,590, $xtop); // vertical line
        $pdf->line($xleft, $xtop+=45,$xleft, $xtop-=45); //left line 
        $pdf->line(590, $xtop+=45,590, $xtop-=45); //right line 
        $pdf->line(120, $xtop+=45,120, $xtop-=45); //left line
        ...
        $pdf->setColor(0, 0, 0);
        $pdf->ezPlaceData($xleft+=6, $xtop-21, 'From:', 12, 'left' );
        $pdf->ezPlaceData($xleft+=95, $xtop-21, $rs_main_docnum['mf_buyers_buyername'], 12, 'left' );
        $xleft = 25;
        $pdf->ezPlaceData($xleft+=6, $xtop-37, 'Address:', 12, 'left' );
        $pdf->ezPlaceData($xleft+=95, $xtop-37, $rs_main_docnum['mf_buyers_buyeraddress'], 11, 'left' );
        ...
        //$pdf->rectangle($xleft, $xtop-=30, 200, 0);
        $pdf->setColor(0.7, 0.7, 0.7, 'fill');
        $pdf->filledRectangle(135 , $xtop-40, 455, 30); // Adjust as needed

        $pdf->setColor(0, 0, 0);
        $pdf->ezPlaceData($xleft+=6, $xtop-21, 'Declared Amount:', 12, 'left' );
        $pdf->ezPlaceData($xleft+=110, $xtop-21, $rs_main_docnum['mf_buyers_buyername'], 12, 'left' );
        $xleft = 25;
        $pdf->ezPlaceData($xleft+=6, $xtop-37, 'Declared Item:', 12, 'left' );
        $pdf->ezPlaceData($xleft+=110, $xtop-37, $rs_main_docnum['mf_buyers_buyeraddress'], 11, 'left' );
        $xleft = 25;
        ...
        $pdf->line($xleft, $xtop+=30,$xleft, $xtop-=30); //left line 
        $pdf->line(590, $xtop+=30,590, $xtop-=30); //right line 
        $pdf->line(135, $xtop+=30,135, $xtop-=30); //left line
        ...
        $pdf->setColor(0, 0, 0);
        $pdf->ezPlaceData($xleft+=6, $xtop-21, 'Forwarder:', 12, 'left' );
        $pdf->ezPlaceData($xleft+=95, $xtop-21, $rs_main_docnum['mf_buyers_buyername'], 12, 'left' );
        $xleft = 25;
        $pdf->ezPlaceData($xleft+=6, $xtop-37, 'Address:', 12, 'left' );
        $pdf->ezPlaceData($xleft+=95, $xtop-37, $rs_main_docnum['mf_buyers_buyeraddress'], 11, 'left' );
        ...
        $pdf->setColor(1, 0, 0); // RGB values as floats: red = 1, green = 0, blue = 0
        $pdf->ezPlaceData($xleft, $xtop, 'Name: ', 10, 'left' );
        $pdf->setColor(0, 0, 0); // RGB values as floats: red = 1, green = 0, blue = 0
        $pdf->ezPlaceData($xleft+=35, $xtop, $rs_main_docnum['mf_buyers_buyername'], 10, 'left' );
