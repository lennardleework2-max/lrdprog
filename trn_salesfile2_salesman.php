...
?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-11 d-flex align-items-center justify-content-end">
                                                    ...
                                                    <div class="m-2 row">
                                                        ...
                                                        <div class="col-md-1 col-6 d-flex justify-content-end ps-0">
                                                            <input type="button" class="btn btn-danger fw-bold" style="width:100px;" value="Back" onclick="back_page()">                                           
                                                        </div>

                                                        <div class="col-md-2 col-4 d-flex justify-content-center ps-0 pe-1">
                                                            <input type="button" data-bs-toggle="modal" data-bs-target="#drModal" class="btn btn-info fw-bold" style="width:100px;" value="Print DR">                                           
                                                        </div>     
                                                        
                                                        <div class="col-md-3 col-4 d-flex justify-content-end ps-1 pe-0">
                                                            <input type="button" data-bs-toggle="modal" onclick="print_declaration()" class="btn btn-info fw-bold" value="Print Declaration Form">                                           
                                                        </div>  


                                                        <div class="col-md-3 col-6 d-flex justify-content-end ps-0 pe-2">
                                                            <input type="button" class="btn btn-success fw-bold" style="width:150px;" value="Save and Exit" onclick="salesfile2('save_exit')">
                                                        </div>

                                                        <div class="col-md-3 col-6 d-flex justify-content-start justify-content-md-end ps-1 pe-1 mt-1 mt-md-0">
                                    ...
                                    <tr class="m-1 edit_row salesfile1" style="border-bottom:3px solid #cccccc ">
                                        ...
                                        <td>
                                            <div class="m-3">
                                                ...
                                                <label for="" style="font-weight:bold">Shop Name:</label>
                                    ...
                                    <tr class="m-1 edit_row salesfile1" style="border-bottom:3px solid #cccccc ">
                                        <td colspan="1">
                                            <div class="m-3">
                                                ...
                                                <select name="sel_salesman_id" id="sel_salesman_id" class="form-control">
                                                    <?php
                                                    ...
                                                    <option value="<?php echo $rs_salesman['salesman_id'];?>" <?php echo $selected_salesman;?>><?php echo $rs_salesman['salesman_name'];?></option>
                                                    <?php endwhile; ?>
                                                </select>
        ...
        $('#insert_modal_sales').on('shown.bs.modal', function () {

            xdata = "event_action=wholesale_add";
            ...
            jQuery.ajax({    
                ...
                url:"trn_salesfile2_ajax.php", 
                    success: function(xdata){  
                        $("#wholesaleprc_add").val(xdata["wholesaleprc"]);
                    }
        ...
        function salesfile2(event,recid){
            ...
            switch(event){
                ...
                case "open_add":
                    ...
                    var current_itmcde = $("#itmcde_add").val();
                    var xdata = "event_action=getCurrentStock&current_itmcde="+current_itmcde;
                    ...
                    jQuery.ajax({    
                        ...
                        success: function(xdata){  
                            ...
                            $("#current_stock_add").val(xdata['currentStockToday']);
                            $("#price_add").val('');
                            $("#amount_add").val('');
                            $("#itmqty_add").val('');
        ...
        $('#itmcde_add').on('change', function() {
            ...
            var xdata = "event_action=getCurrentStock&current_itmcde="+selectedValue;
            jQuery.ajax({    
                data:xdata,
                dataType:"json",
                type:"post",
        ...
        $('#itmcde_edit').on('change', function() {
            ...
            jQuery.ajax({    
                ...
                success: function(xdata){  
                    ...
                    //$("#current_stock_add").val(xdata['currentStockToday']);
                    $("#wholesaleprc_edit").val(xdata["wholesaleprc"]);
                    //$("#insert_modal_sales").modal("show");
