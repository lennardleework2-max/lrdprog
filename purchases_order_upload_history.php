...
?>
    ...
    <form name='myforms' id="myforms">
            ...
            <tr colspan=1>
                ...
                <td colspan=1 class="td_br">
                    <div class="container-fluid pt-2 main_br_div">
                        ...
                        <div class="container-fluid my-2">
                            <div class="row">
                                <div class="col-12 col-md-6" style='padding-left:0;margin-left:0;'>
                                    <h2 class='my-2'>Purchases Order Upload History</h2>
                                </div>
                        ...
                        <table class="shadow data_table" style='border-radius:.75rem!important;width:100%;margin-bottom:1rem' id='po_history_main_table'>
                            <thead style='border-bottom:2px solid black;'>
                                <tr>
                                    <th scope="col" style='padding: 0.5rem;font-size:18px'>Filename</th>
                                    <th scope="col" style='padding: 0.5rem;font-size:18px'>Date Uploaded</th>
                                    <th scope="col" style='padding: 0.5rem;font-size:18px'>Order Number</th>
                                    <th scope="col" style='padding: 0.5rem;font-size:18px'>Docnum</th>
                                    <th scope="col" style='padding: 0.5rem;font-size:18px'>User</th>
        ...
        <span id='hidden_search_input'>
            ...
            <input type="hidden" name="docnum_search_h" id="docnum_search_h" value="<?php if(isset($_POST['docnum_search_h'])){echo htmlspecialchars($_POST['docnum_search_h'], ENT_QUOTES);} ?>">
        ...
        <div class="modal-dialog">
            <div class="modal-content fw-bold">
                <div class="modal-header">
                    <h5 class="modal-title" id="searchModalLabel">Search Purchases Order Upload History</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row m-3">
                        ...
                        <div class="col-12 col-md-6 mt-3 mt-md-0">
                            <label for="docnum_search">Docnum:</label>
...
<script>
    ...
    function page_click(event_action){
        ...
        jQuery.ajax({
            ...
            dataType: "json",
            type: "post",
            url: "purchases_order_upload_history_ajax.php",
    ...
    function viewDetails(fileName){
        ...
        document.forms.myforms.action = "purchases_order_upload_history2.php";
