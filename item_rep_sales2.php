<?php
    ...
    while($rs_main = $stmt_main->fetch()){    
        ...
        $select_db2 = "SELECT * FROM tranfile2 LEFT JOIN tranfile1 ON tranfile2.docnum= tranfile1.docnum WHERE itmcde='".$rs_main['itmcde']."' ".$xfilter2." AND tranfile1.trncde='".$_POST['trncde_hidden']."' ORDER BY tranfile1.trndte ASC";
        ...
        $pdf->ezPlaceData(580,$xtop-9,"<b>Subtotal:</b>",9 ,'left');
