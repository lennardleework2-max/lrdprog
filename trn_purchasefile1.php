...
?>         
    ...
    <form name='myforms' id="myforms"> 
                        ...
                        <div class="container-fluid mt-2 main_br_div">
                            ...
                            <table class="shadow" style='border-radius:.75rem!important;width:100%;margin-bottom:1rem' id='sales_main_table'>
                                <thead style='border-bottom:2px solid black;'>
                                    <tr>
                                    <th scope="col" style='width:80%;padding: 0.5rem 0.5rem;font-size:23px'>Purchases</th>
                                    <?php
            ...
            <span id='hidden_search_input'>
                ...
                <input type="hidden" name="crud_hide_hidden" id="crud_hide_hidden" value="<?php if(isset($hide_price_crud)){echo $hide_price_crud;} ?>">
            </span>
    </form> 
    ...
    <div class="modal fade" id="searchModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content fw-bold">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Search Purchases</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
    ...
    <script>
        ...
        function ajaxFunc2(event ,recid, xextra){
            ...
            switch(event) {
                ...
                case "getEdit":
                    ...
                    document.forms.myforms.action = "trn_purchasefile2.php";
            ...
            jQuery.ajax({    
                ...
                dataType:"json",
                type:"post",
                url:"trn_purchasefile1_ajax_crud.php", 
        ...
        function page_click_sales(event_action, xextra){
            ...
            var crud_hide_hidden_val = $("#crud_hide_hidden").val();
            var xdata= $("#hidden_search_input *").serialize()+"&first_load="+first_load+"&pageno="+pageno+"&event_action="+event_action+"&crud_hide_hidden="+crud_hide_hidden_val;
            ...
            jQuery.ajax({    
                ...
                dataType:"json",
                type:"post",
                url:"trn_purchasefile1_ajax_pager.php", 
