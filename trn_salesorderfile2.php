...
if(isset($_POST['recid_hidden']) && !empty($_POST['recid_hidden'])){
    ...
    while($rs_docnum1 = $stmt_docnum1->fetch()){
        ...
        if(isset($rs_docnum1['order_status'])){
            
            $order_status_pending  = "";
            $order_status_cancelled = "";
            $order_status_completed = "";

            if($rs_docnum1['order_status'] == 'pending'){
                $order_status_pending  = "selected";
            }else if($rs_docnum1['order_status'] == 'cancelled'){
                $order_status_cancelled  = "selected";
            }else if($rs_docnum1['order_status'] == 'completed'){
                $order_status_completed  = "selected";
            }
...
/* 
                                    ...
                                    <tr class="m-1 edit_row salesfile1" style="border-bottom:3px solid #cccccc ">
                                       <td>
                                            <div class='row mx-2'>
                                                ...
                                                <div class="col-md-4 col-6 p-3">
                                                    <label for="" style="font-weight:bold">Date Ordered:<span style="color:red">*</span></label>
                                        ...
                                        <td>
                                            <div class='row mx-2'>
                                                ...
                                                <div class="col-md-8 col-6 p-3">
                                                    ...
                                                    <select name="orderby_1" id="orderby_1" class="form-control">
                                                        <?php
                                    ...
                                    <tr class="m-1 edit_row salesfile1" style="border-bottom:3px solid #cccccc ">
                                        <td>
                                            <div class="row mx-2">
                                                ...
                                                <div class="col-md-4 col-6 p-3">
                                                    <label for="" style="font-weight:bold">Order Num.<span style='font-weight:normal'></span></label>
                                                    <input type="text" class="form-control" name="order_num_1" id="order_num_1" value="<?php echo $order_num;?>" autocomplete="off">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mx-2">
                                                ...
                                                <div class="col-md-4 col-6 p-3">
                                                    ...
                                                    <div class='mt-2'>
                                                        ...
                                                        <select name="order_status1" id="order_status1" class="form-control">
                                                            <option <?php echo $order_status_pending; ?>>pending</option>
                                                            <option <?php echo $order_status_completed; ?>>completed</option>
                                                            <option <?php echo $order_status_cancelled; ?>>cancelled</option>
                                                        </select>  
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row m-3">
                                <div class="col-12">
                                    <label for="">Wholesale Price</label>
                                    <input type="text" name="wholesaleprc_edit" id="wholesaleprc_edit" class="form-control" autocomplete="off">
                                </div>
                            </div>
        ...
        function select_item_modal(xitmcde, xitmdsc, xcurrent_stock, xwholesaleprc, xevent_action){
            ...
            if(xevent_action == 'add'){
                ...
                $("#wholesaleprc_add").val(xwholesaleprc);
        ...
        function salesfile2(event,xrecid){
            ...
            switch(event){
                case "save_exit":
                    ...
                    var cusname1_val = $("#cusname_1").val();
                    var xdata = $(".salesfile1 *").serialize()+"&event_action=save_exit&docnum="+docnum+"&xtrndte_1="+trndte_1_val+"&xcusname_1="+cusname1_val;
                    break;
                case "save_new":
                    var trndte_1_val = $("#trndte_1").val();
                    var cusname1_val = $("#cusname_1").val();
                    var xdata = $(".salesfile1 *").serialize()+"&event_action=save_new&docnum="+docnum+"&xtrndte_1="+trndte_1_val+"&xcusname_1="+cusname1_val;
                    break;
                case "open_add":
                ...
                case "insert":
                    var trndte_1_val = $("#trndte_1").val();
                    var cusname1_val = $("#cusname_1").val();
                    var xdata  = $("#insert_modal_sales *").serialize()+"&event_action="+event+"&docnum="+docnum+"&xtrndte_1="+trndte_1_val+"&xcusname_1="+cusname1_val+"&"+$(".salesfile1 *").serialize();
                break;
                case "submitEdit":
                    var recid = $("#salesfile2_recid_hidden").val();
                    var trndte_1_val = $("#trndte_1").val();
                    var cusname1_val = $("#cusname_1").val();
                    var xdata  = $("#edit_modal_sales *").serialize()+"&event_action="+event+"&docnum="+docnum+"&recid="+recid+"&xtrndte_1="+trndte_1_val+"&xcusname_1="+cusname1_val;
                break;
                case "getEdit": 
            ...
            jQuery.ajax({    
                ...
                success: function(xdata){  
                        ...
                        if(xdata["msg"] == "save_new_last" || xdata["msg"] == "save_new_same"){
                            ...
                            $("#order_status1").val($("#order_status1 option:first").val());
