...
?>
                            ...
                            <table style='height:80%;background-color:white;width:40%' id='docnum_table'>
                                <tr>
                                    <td colspan="2" class="text-center">
                                        <h3>Sales Order </br>by Doc. Num (Summarized)</h3>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <div class="row d-flex justify-content-center align-items-center">
                                            <div class="col-md-4 col-6 ps-md-0 d-flex justify-content-center">
    ...
    <script>
            function exp_pdf(){
                ...
                document.forms.myforms.action = "docnum_rep_salesorder.php";
