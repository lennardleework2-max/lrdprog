...
?>
                            ...
                            <table style='height:80%;background-color:white;width:40%' id='docnum_table'>
                                    ...
                                    <td colspan="1">
                                        <div class="w-100 h-100 d-flex justify-content-end align-items-top pe-1">
                                            <div style="width:80%">
                                                ...
                                                <input type="text" class="form-control date_picker" name="date_ordered_from" id="date_ordered_from" autocomplete="off" readonly>
                                            </div>
                                        </div>
                                    </td>
                                    <td colspan="1">
                                        <div class="w-100 h-100 d-flex justify-content-start align-items-top ps-1">
                                            <div style="width:80%">
                                                ...
                                                <input type="text" class="form-control date_picker" name="date_ordered_to" id="date_ordered_to" autocomplete="off" readonly>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr style='height:20%'>
                                    <td colspan="1">
                                        <div class="w-100 h-100 d-flex justify-content-end align-items-top pe-1">
                                            <div style="width:80%">
                                                <label for="">Upload Date From:</label>
                                    ...
                                    <td colspan="1">
                                        <div class="w-100 h-100 d-flex justify-content-start align-items-top ps-1">
                                            <div style="width:80%">
                                                <label for="">Upload Date To:</label>
                                    ...
                                    <td colspan="2">
                                        <div class="w-100 h-100 d-flex justify-content-center align-items-top">
                                            <div class="m-2" style='width:80%'>
                                                ...
                                                <select class="form-select" id="cus_search" name="cus_search" autocomplete="off">
    ...
    <script>
            function exp_pdf(){
                ...
                document.forms.myforms.action = "so_rep_sales.php";
