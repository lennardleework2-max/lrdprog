...
$stmt_floor = $link->prepare("SELECT warehouse_floor_id, warcde, floor_no FROM warehouse_floor ORDER BY floor_no ASC, floor_name ASC, warehouse_floor_id ASC");
$stmt_floor->execute();
...
// echo "<pre>UOM Options: "; print_r($uom_options); echo "</pre>"; exit;
                                ...
                                <table class="bg-white w-75 shadow rounded user_access_tbl my-4"  id="file2_table" style="border-radius: 0.75rem!important;border-collapse:collapse;height:400px;min-width:0">
                                    ...
                                    <tr class="m-1 edit_row salesfile1" style="border-bottom:3px solid #cccccc ">
                                        <td colspan="3">
                                            <div class="row px-2">
                                                <div class="p-3">
                                                    <label for="" style="font-weight:bold">Ref Number:</label>
