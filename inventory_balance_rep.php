<?php
    ...
    $fields = '';
        ...
        $pdf->ezPlaceData($xleft+=140,$xtop,"<b>Balance</b>",10,'left');
    ...
    while($rs_main = $stmt_main->fetch()){    
		...
		// }else{
        //     $rs_main["customerfile_cusdsc"] = trim_str($rs_main["customerfile_cusdsc"],94,9);
        ...
        //     $rs_main["tranfile1_ordernum"] = trim_str($rs_main["tranfile1_ordernum"],70,9);
        // }
        ...
        $pdf->ezPlaceData($xleft+=140,$xtop,$item_total,9,"left");
        $xtop -= 15;
