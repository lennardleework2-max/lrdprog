                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-10 d-flex align-items-center justify-content-end">
                                                    ...
                                                    <div class="m-2 row">
                                                        ...
                                                        <div class="col-md-2 col-6 d-flex justify-content-end ps-0 pe-2">
                                                            <input type="button" class="btn btn-danger fw-bold" style="width:100px;" value="Back" onclick="back_page()">                                           
                                                        </div>

                                                        <div class="col-md-2 col-4 d-flex justify-content-end ps-0 pe-1">
                                                        ...
                                                        <div class="col-md-3 col-6 d-flex justify-content-end ps-0 pe-0">
                                                            <input type="button" class="btn btn-success fw-bold" style="width:150px;" value="Save and Exit" onclick="salesfile2('save_exit')">
                                                        </div>

                                                        <div class="col-md-4 col-6 d-flex justify-content-start justify-content-md-end ps-1 pe-1 mt-1 mt-md-0">
