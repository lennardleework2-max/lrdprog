<?php
    ...
    $xprog_module_log = 'SALES RETURN';
    $xactivity_log = 'export_pdf';
    $xremarks_log = "Exported PDF from Sales Return";
    ...
    $fields = '';
        ...
        $pdf->ezPlaceData($xleft+=105,$xtop,"<b>Order By:</b>",10,'left');
        ...
        $pdf->ezPlaceData($xleft+=115,$xtop,"<b>Total:</b>",10,'left');
