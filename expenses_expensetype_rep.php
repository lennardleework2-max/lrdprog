...
<style>
                            ...
                            <table style='height:80%;background-color:white;width:40%' id='docnum_table'>
                                <tr>
                                    <td colspan="2" class="text-center">
                                        <h3>Expenses</br>by Expense Type</h3>
                                    </td>
                                </tr>
                                    ...
                                    <td colspan="2">
                                        <div class="w-100 h-100 d-flex justify-content-center align-items-top">
                                            <div class="m-2" style='width:80%'>
                                                ...
                                                <select class="form-select" id="expense_type" name="expense_type" autocomplete="off">

                                                    <?php
                                                        $select_db_expensetype="SELECT * FROM expensetypefile ORDER BY expense_dsc";
                                                        $stmt_expensetype	= $link->prepare($select_db_expensetype);
    ...
    <script>
            function exp_pdf(){
                ...
                document.forms.myforms.action = "expensetype_rep_expenses.php";
