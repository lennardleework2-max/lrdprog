<?php
    ...
    $fields = '';
        ...
        $pdf->ezPlaceData($xleft+=80,$xtop,"<b>Shop Name</b>",10,'left');
        $pdf->ezPlaceData($xleft+=85,$xtop,"<b>Ship To</b>",10,'left');
    ...
    while($rs_main = $stmt_main->fetch()){    
        ...
        $pdf->ezPlaceData($xleft+=85,$xtop,$rs_main["tranfile1_shipto"],9,"left");
    ...
    $pdf->ezPlaceData(520,$xtop-18,"<b>Grand total:</b>",9 ,'right');
    $pdf->ezPlaceData(585,$xtop-18,"<b>".number_format($grand_total,2)."</b>",9 ,'right');
