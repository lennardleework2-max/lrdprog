<?php
    ...
    if(isset($_POST["event_action"]) && $_POST["event_action"] == "getEdit"){
        ...
        $select_salesorderfile2="SELECT salesorderfile2.itmcde as 'itmcde', salesorderfile2.itmqty, salesorderfile2.untprc, salesorderfile2.extprc, itemfile.itmdsc, salesorderfile2.recid as salesorderfile2_recid FROM salesorderfile2 LEFT JOIN itemfile ON itemfile.itmcde = salesorderfile2.itmcde WHERE salesorderfile2.recid=?";
    ...
    if(isset($_POST["event_action"]) && $_POST["event_action"] == "delete"){
        ...
        // }
            ...
            $select_salesfile2="SELECT salesorderfile2.docnum as salesorderfile2_docnum, itemfile.itmdsc as itemfile_itmdsc,itemfile.itmcde as itemfile_itmcde, salesorderfile2.itmqty, salesorderfile2.untprc, salesorderfile2.extprc, salesorderfile2.recid as salesorderfile2_recid
