...
?>
                            ...
                            <table style='height:80%;background-color:white;width:40%'>
                                <tr>
                                    <td colspan="2" class="text-center">
                                        <h3>Stock Card(With Filter and Price)</h3>
                                    </td>
                                </tr>
                                    ...
                                    <td colspan="2">
                                        <div class="w-100 h-100 d-flex justify-content-center align-items-top">
                                            <div class="m-2" style='width:80%'>
                                                <label for="">Sort Items:(Alphabetical)</label>
                                                <select class="form-select" id="sort_filter_alphabetical" name="sort_filter_alphabetical" autocomplete="off">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div class="w-100 h-100 d-flex justify-content-center align-items-top">
                                            <div class="m-2" style='width:80%'>
                                                <label for="">Sort Items:(Amount)</label>
                                                <select class="form-select" id="sort_filter" name="sort_filter" autocomplete="off">
                                                        <option value="ASC">Ascending</option>
                                                        <option value="DESC">Descending</option>
                                                </select>
                                            </div>
    ...
    <script>
            function exp_pdf(){
                ...
                document.forms.myforms.action = "stock_card3_rep.php";
