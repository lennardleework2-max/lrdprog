...
*/
    ...
    // $pdf->ezPlaceData(25,25,$select_db,1,'left');    
    ...
    while($rs_main = $stmt_main->fetch()){    
        ...
        if ($rs_main["mf_salesman_name"] != $xpre_salesman)
        {
            if ($xpre_salesman !='**'){
                ...
                sales_return($xactual_rows_count,$table_row_count,true);
        ...
        {   
            ...
            $pdf->ezPlaceData(435,$xtop,"<b>Total Sales for 2222 ".$xpre_salesman."</b>",9,"left");
            $pdf->ezPlaceData(650,$xtop,"<b>".number_format($subtotal,"2")."</b>",9,"right");
            $smn_com = $subtotal*($xcommission/100);
            $pdf->ezPlaceData(760,$xtop,"<b>".number_format($smn_com,"2")."</b>",9,"right");
            $pdf->ezPlaceData(435,$xtop-=15,"<b>Commission at ".number_format($xcommission,"2")." % </b>",9,"left");
                ...
                sales_return($xactual_rows_count,$table_row_count,false);
    ...
    function sales_return($passed_row_count, $xtable_row_count,$xinclude)
    {
        ...
        LEFT JOIN mf_salesman ON tranfile1.salesman_id = mf_salesman.salesman_id 
        LEFT JOIN mf_buyers ON tranfile1.buyer_id = mf_buyers.buyer_id 
        WHERE true AND trncde='SRT' ".$xfilter." and tranfile1.salesman_id='" .$xpre_salesman_id . "' ORDER BY mf_salesman.salesman_id ASC,tranfile1.trndte ASC";
