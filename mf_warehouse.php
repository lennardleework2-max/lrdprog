...
$active_view = (isset($_GET['view']) && $_GET['view'] === 'floor') ? 'floor' : 'warehouse';
?>
            ...
            <tr colspan=1>
                ...
                <td colspan=1 class="td_br" id="td_br">
                    ...
                    <div class="container-fluid pt-2 main_br_div">
                        ...
                        <div class="mb-2">
                            <a href="mf_warehouse.php" class="btn btn-sm <?php echo ($active_view === 'warehouse') ? 'btn-primary' : 'btn-outline-primary'; ?> me-2">Warehouse</a>
                            <a href="mf_warehouse.php?view=floor" class="btn btn-sm <?php echo ($active_view === 'floor') ? 'btn-primary' : 'btn-outline-primary'; ?>">Warehouse Floor</a>
                        </div>

                        <?php
                            if($active_view === 'warehouse'){
