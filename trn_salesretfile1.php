...
?>         
                        ...
                        <div class="container-fluid mt-2 main_br_div">
                            ...
                            <table class="shadow" style='border-radius:.75rem!important;width:100%;margin-bottom:1rem' id='sales_main_table'>
                                <thead style='border-bottom:2px solid black;'>
                                    <tr>
                                    <th scope="col" style='width:80%;padding: 0.5rem 0.5rem;font-size:23px'>Sales Return</th>
                                    <?php
    ...
    <div class="modal fade" id="searchModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content fw-bold">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Search Sales Return</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
    ...
    <script>
        ...
        function ajaxFunc2(event ,recid, xextra){
            ...
            switch(event) {
                ...
                case "getEdit":
                    ...
                    document.forms.myforms.action = "trn_salesretfile2.php";
            ...
            jQuery.ajax({    
                ...
                dataType:"json",
                type:"post",
                url:"trn_salesretfile1_ajax_crud.php", 
        ...
        function print_file2(recid){
            ...
            document.forms.myforms.action = "salesret_tranfile2_pdf.php";
            document.forms.myforms.submit();
        }
        ...
        function page_click_sales(event_action, xextra){
            ...
            jQuery.ajax({    
                ...
                dataType:"json",
                type:"post",
                url:"trn_salesretfile1_ajax_pager.php", 
