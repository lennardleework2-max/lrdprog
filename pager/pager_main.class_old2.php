...
Class pager extends db_init{
    ...
    public $field_chkbox_true_val = array(); //keyword for a true value if 'checked' then we will look for
    public $field_chkbox_selected_only_crud = array();
    public $field_chkbox_false_val = array();
    ...
    public $add_custom_btn_title; // title of the button
    public $add_custom_btn_function;  // function name of the button
    public $add_custom_btn_class;  // class of the button
    public $add_custom_btn_logo;  // logo of the button
    ...
    public $btn_parameter = array();

    //delete will be custom
    public $custom_delete_bom = 'false';
    ...
    public function display_table(){
                ...
                echo"<div class='row'>";
                    ...
                    echo"<div class='col-12 col-sm-6 mx-0 px-0'>";
                        ...
                        if(isset($this->display_only) && $this->display_only == "Y"){
                            ...
                            echo "
                            <div class='row'>
                                <div class='col-auto div_header_main'>
                                ...
                                if((isset($this->add_custom_btn_title) && !empty($this->add_custom_btn_title)) && 
                                (isset($this->add_custom_btn_function) && !empty($this->add_custom_btn_function)) && 
                                (isset($this->add_custom_btn_class) && !empty($this->add_custom_btn_class)) &&
                                (isset($this->add_custom_btn_logo) && !empty($this->add_custom_btn_logo))){
                                   echo "<div class='col-auto mx-0 px-0' style='display:flex;align-items:center'>
                                    <button type='button' class='".$this->add_custom_btn_class."' value='".$this->add_custom_btn_title."' onclick='".$this->add_custom_btn_function."()'>
                                   <span style='font-weight:bold'>
                                       ".$this->add_custom_btn_title."
                                   </span>
    
                                   ".$this->add_custom_btn_logo."
                               </button></div>";
                               }                                
                        ...
                        if($this->display_only !== "Y"|| empty($this->display_only)){
                            ...
                            (isset($this->add_custom_btn_class) && !empty($this->add_custom_btn_class)) &&
                            (isset($this->add_custom_btn_logo) && !empty($this->add_custom_btn_logo))){
                               echo "<button type='button' class='".$this->add_custom_btn_class."' value='".$this->add_custom_btn_title."' onclick='".$this->add_custom_btn_function."()'>
                               <span style='font-weight:bold'>
                                   ".$this->add_custom_btn_title."
                               </span>
            ...
            echo"<table style='display:none' id='display_data_hidden'>";
                echo"<tr>";
                    ...
                    foreach($this->field_name_dis as $field_name_dis_key => $field_name_dis_value){
                        ...
                        if(isset($this->field_chkbox_true_val[$field_name_dis_key])){
                            $field_chkbox_true_val   = $this->field_chkbox_true_val[$field_name_dis_key];
                        }else{
                            $field_chkbox_true_val   = '';
                        }

                        if(isset($this->field_chkbox_false_val[$field_name_dis_key])){
                            $field_chkbox_false_val   = $this->field_chkbox_false_val[$field_name_dis_key];
                        }else{
                            $field_chkbox_false_val   = '';
                        }
                        ...
                        if($field_type_dis_hidden == "text" ||
                            ...
                            echo "<input 
                                ...
                                data-field-chkbox-true-val ='".$field_chkbox_true_val."'
                                data-field-chkbox-false-val ='".$field_chkbox_false_val."'
        ...
        //display only
        echo "<input type='hidden' name='custom_delete_bom_hidden' id='custom_delete_bom_hidden' value='".$this->custom_delete_bom."'>";
        ...
        foreach($this->btn_header as $btn_header_key => $btn_header_value){
            ...
            $btn_parameter = $this->btn_parameter[$btn_header_key];
                    ...
                    echo "<div class='modal-body'>";
                        ...
                        foreach($this->field_name_crud as $field_name_crud_key => $field_name_crud_value){
                            ...
                            if($field_type_crud == "text"){
                                ...
                                if(isset($this->field_chkbox_selected_only_crud[$field_name_crud_key])){
                                    $field_chkbox_selected_only_crud = $this->field_chkbox_selected_only_crud[$field_name_crud_key];
                                }else{
                                    $field_chkbox_selected_only_crud = 0;
                                }
                                ...
                                echo "<div class='row m-3' id='crudModal_values'>";
                                    echo "<div class='col-12'>";
                                        ...
                                        echo "<input 
                                            ...
                                            data-is-unique='".$is_unique."_crudModal'
                                            data-field-type='".$field_type_crud."'
                                            data-field-chkbox-selected-only-crud='".$field_chkbox_selected_only_crud."'
