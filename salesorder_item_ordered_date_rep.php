...
1
                            ...
                            <table style='height:80%;background-color:white;width:40%' id='date_table'>
                                <tr>
                                    <td colspan="2" class="text-center">
                                        <h3>Sales Order </br> by Item (Ordered Date)</h3>
                                    </td>
                                </tr>
    ...
    <script>
            function exp_pdf(){
                ...
                document.forms.myforms.action = "item_ordered_date_rep_salesorder.php";
            ...
            function exp_txt(){
                ...
                document.forms.myforms.target = "_blank";
                document.forms.myforms.method = "post";
                //document.forms.myforms.action = "item_ordered_date_txt_salesorder.php";
                document.forms.myforms.action = "item_ordered_date_rep_salesorder.php";
                document.forms.myforms.submit();
            }
    </script>
