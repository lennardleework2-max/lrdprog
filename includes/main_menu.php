        ...
        <nav class="sidebar card" style="background-color:#212529">
            <ul class="nav flex-column">
                    ...
                    <?php 
                        ...
                        $order_menu="AND menidx!='x' AND is_removed!='1' AND usercode ='".$_SESSION['usercode']."' ORDER BY menidx";

                        if($_SESSION["userdesc"] == "admin"){
                            $order_menu2="AND menidx!='x' AND is_removed!='1' ORDER BY menidx";
                        ...
                        <?php if(!empty($row_menu["mensub"])):?>
                            <li class="nav-item has-submenu">
                                <a href="#" class="nav-link">
                                    <i class="<?php echo $row_menu["menlogo"] ?>" id="nav-logo"></i>
                                    <span  style='-webkit-box-decoration-break: clone;' class="nav-txt"><?php echo $row_menu["mencap"]; ?></span>
                                </a>
                                ...
                                <ul class="submenu collapse ul_menu ul_menu1" style="list-style-type: none">
                                    ...
                                    <?php
                                        ...
                                        if($_SESSION["userdesc"] == "admin"){ 
                                            $select_db_menu2="SELECT * FROM menus where mengrp='".$mengrp."' AND is_removed!='1' ".$order_menu2;
                                        }else{
                                            $select_db_menu2="SELECT * FROM user_menus where mengrp='".$mengrp."' AND is_removed!='1' and usercode='".$_SESSION['usercode']."' ".$order_menu2;
                                        }
                                    ...
                                    ?>
                                        ...
                                        <?php if(!empty($row_menu2["mensub"])):?>
                                            <li class="nav-item has-submenu">
                                                <a href="#" class="nav-link">
                                                    <i class="<?php echo $row_menu2["menlogo"] ?>" id="nav-logo" style='margin-left:8px;'></i>
                                                    <span style='-webkit-box-decoration-break: clone;' class="nav-txt"><?php echo $row_menu2["mencap"]; ?></span>
                                                </a>
                                                        ...
                                                        while($row_menu3 = $stmt_menu3->fetch()):?>
                                                            <li>
                                                                <a href="<?php echo $row_menu3["menprogram"]; ?>" class="nav-link">
                                                                    <i class="<?php echo $row_menu3["menlogo"] ?>" id="nav-logo" style='margin-left:16px;'> 
                                                                    </i>
                                        ...
                                        <?php else:?>
                                            <li>
                                                <a href="<?php echo $row_menu2["menprogram"]; ?>" class="nav-link">
                                                    <i class="<?php echo $row_menu2["menlogo"] ?>" id="nav-logo" style='margin-left:8px;'> 
                                                    </i>
                                                    <span class="nav-txt"  style='-webkit-box-decoration-break: clone;'>
                        ...
                        <?php elseif(empty($row_menu["mensub"])):?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo $row_menu["menprogram"];?>">
                                    <i class="<?php echo $row_menu["menlogo"] ?>" id="nav-logo"></i><span class="nav-txt" style='-webkit-box-decoration-break: clone;'><?php echo $row_menu["mencap"]; ?></span>
                                </a>
                            </li>
                        <?php endif; ?>
                    <?php endwhile; ?>
