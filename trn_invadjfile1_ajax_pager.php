...
$select_db_xtotal = "SELECT count(*) as rec_count FROM tranfile1 LEFT JOIN customerfile ON tranfile1.cuscde = customerfile.cuscde WHERE true AND trncde='".$trncde."' ".$xfilter;
...
$select_db="SELECT tranfile1.shipto as tranfile1_shipto,tranfile1.cuscde as tranfile1_cuscde,tranfile1.docnum as tranfile1_docnum, tranfile1.remarks as tranfile1_remarks,
...
tranfile1.cuscde = customerfile.cuscde WHERE true AND trncde='".$trncde."' ".$xfilter." LIMIT ".$xlimit." OFFSET ".$xoffset;
...
while($row_main = $stmt->fetch()){
        ...
        $xret["html"] .= "<td data-label='Username' style='width:80%;font-size:20px;".$xtop_border_action."'>
            ...
            border-collapse:collapse' id='trn_sales_table'>
                    ...
                    <tr style='border-right:2px solid gray;'> 
                        ...
                        <td style='max-width:400px;padding:0.3rem;font-weight:bold'>
    ...
    $xret["html_mobile"] .= "<tr>";
        $xret["html_mobile"] .= "<td style='font-weight:bold'>Ref. Number</td>";
        $xret["html_mobile"] .= "<td>".$row_main['tranfile1_ordernum']."</td>";
    $xret["html_mobile"] .= "</tr>";

    $xret["html_mobile"] .= "<tr>";
        $xret["html_mobile"] .= "<td style='font-weight:bold'>Remarks</td>";
        $xret["html_mobile"] .= "<td>".$row_main['tranfile1_remarks']."</td>";
    $xret["html_mobile"] .= "</tr>";
