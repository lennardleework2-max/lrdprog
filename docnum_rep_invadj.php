<?php
    ...
    $fields = '';
        ...
        // $pdf->ezPlaceData($xleft+=80,$xtop,"<b>Customer</b>",10,'left');
        ...
        $pdf->ezPlaceData($xleft+=115,$xtop,"<b>Total</b>",10,'right');
    ...
    while($rs_main = $stmt_main->fetch()){    
        ...
        // $pdf->ezPlaceData($xleft+=80,$xtop,$rs_main["customerfile_cusdsc"],9,"left");
        ...
        $pdf->ezPlaceData($xleft+115,$xtop,number_format($rs_main["tranfile1_trntot"],"2"),9,"right");
    ...
    $pdf->ezPlaceData(270,$xtop-18,"<b>Grand total:</b>",9 ,'right');
    $pdf->ezPlaceData(320,$xtop-18,"<b>".number_format($grand_total,2)."</b>",9 ,'right');
