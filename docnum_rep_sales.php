<?php
    ...
    $fields = '';
        ...
        $pdf->ezPlaceData($xleft+=60,$xtop,"<b>Shop Name:</b>",10,'left');
        $pdf->ezPlaceData($xleft+=75,$xtop,"<b>Ship To</b>",10,'left');
        $pdf->ezPlaceData($xleft+=135,$xtop,"<b>Paydate</b>",10,'left');
        $pdf->ezPlaceData($xleft+=75,$xtop,"<b>Payment Details</b>",10,'left');
    ...
    tranfile1.cuscde = customerfile.cuscde WHERE true AND tranfile1.trncde='".$_POST['trncde_hidden']."' ".$xfilter." ORDER BY tranfile1.docnum ASC";
    ...
    while($rs_main = $stmt_main->fetch()){    
        ...
        $pdf->ezPlaceData($xleft+=60,$xtop,$rs_main["customerfile_cusdsc"],9,"left");
        ...
        $pdf->ezPlaceData($xleft+=75,$xtop,$rs_main["tranfile1_paydetails"],9,"left");
