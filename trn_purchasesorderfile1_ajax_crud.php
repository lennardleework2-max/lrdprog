...
if($_POST["event_action"] == "delete"){
	...
	$select_db_delete = "SELECT docnum FROM purchasesorderfile1 WHERE recid=? LIMIT 1";
	...
	if($rs_delete){
		...
		PDO_UserActivityLog($link, $log_username, '', $log_trndte, 'PURCHASE ORDER', 'delete', $log_fullname, $log_remarks, 0, '', 'POR', '', '', $log_username, $rs_delete['docnum'], '');
	}
