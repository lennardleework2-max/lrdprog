<?php
    ...
    $xprog_module_log = isset($_POST["progname_hidden"]) ? strtoupper($_POST["progname_hidden"]) : 'SALES TRANSACTION';
    $xactivity_log = 'export_pdf';
    $xremarks_log = "Exported PDF from Sales Transaction";
    ...
    $fields = '';
        ...
        $pdf->ezPlaceData($xleft+=115,$xtop,"<b>Customer:</b>",10,'left');
